					...
					New Board</button>
                        ...
                        <div class="panel-body">
                            ...
                            <form id="searchForm" action="/board/list" method="get" >
                            	...
                            	</select> <!-- selected 검색 후에도 무엇을 선택했는지 볼수 있게-->
                            	<input type="test" name="keyword" value="${pageMaker.cri.keyword}">
                            	<input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}">
                            	<input type="hidden" name="amount" value="${pageMaker.cri.amount}">
                            	<button classe="btn btn-default">Search</button>
                            </form>
...
 
    var result = '<c:out value="${result}"/>'; //만약 정상적으로 작동을 안하면 ""값 반환
 
	console.log(result);
    checkModal(result); 
